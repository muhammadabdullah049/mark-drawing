...
const images = [
    '/assets/product-detail/product-detail-img-1.png',
    '/assets/product-detail/product-detail-img-2.png',
    '/assets/product-detail/product-detail-img-3.png',
    '/assets/product-detail/product-detail-img-4.png',
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-10 relative z-10 overflow-hidden">
            ...
            <div key={index}>
              <Image
                ...
                decoding="async"
                data-nimg="1"
                className={`w-20 h-20 p-2 cursor-pointer border ${
